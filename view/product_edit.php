                            ...
                            <div class="sa-entity-layout__body">
                                <div class="sa-entity-layout__main">
                                    <div class="card">
                                        <div class="card-body p-5">
                                            ...
                                            <div class="mb-4">
                                            <label for="form-product/description" class="form-label">
                                                    Description</label>
                                                <textarea id="form-product/description" class="form-control"
                                                    rows="8" name="motachitiet">
                                                    <?=$data['sp']['motachitiet']?> 
                                                </textarea>
                                            </div>
                                            <div>
                                            ...
                                            <div class="row g-4">
                                                <div class="col">
                                                    <label for="form-product/price"
                                                        ...
                                                        class="form-control" id="form-product/price" name="giakhuyenmai" value="<?=$data['sp']['giakhuyenmai']?>"/>
                                                </div>
                                                <div class="col">
                                                    <label for="form-product/old-price" class="form-label">Old
                                                        price</label><input type="number" class="form-control"
                                                        id="form-product/old-price" name="gia" value="<?=$data['sp']['gia']?>" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="sa-entity-layout__sidebar">
                                    <div class="card">
                                        ...
                                        <div class="mt-n5">
                                            <img src="upload/product/<?=$data['sp']['anhsp']?>" class="w-100">
