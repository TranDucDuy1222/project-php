                                        ...
                                        <?php foreach($data['dsorder'] as $sp): ?>   
                                            ...
                                            <td><input type="checkbox" class="form-check-input m-0 fs-exact-16 d-block"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <a href="admin.php?mod=order&act=chitietdh" class="text-reset"><?=$sp['hovaten']?></a>
                                            ...
                                            <td>
                                                <div class="sa-price">                                              
                                                       <span class="sa-price__integer"><?=$sp['ngaydathang']?></span>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="sa-price">                                              
                                                       <span class="sa-price__integer"><?=$sp['diachi']?></span>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end"
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item" href="admin.php?mod=order&act=edit&id=<?=$sp['madh']?>">Edit</a>
                                                        </li>
