                    ...
                    <div class="py-5">
                        <div class="row g-4 align-items-center">
                            ...
                            <div class="col-auto d-flex">
                                <a href="nhanvien.php?mod=category&act=add" class="btn btn-primary">New category</a>
                            </div>
                        </div>
                    </div>
                </div>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end"
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item" href="nhanvien.php?mod=category&act=edit&id=<?=$dm['madm']?>">Edit</a>
                                                        </li>
